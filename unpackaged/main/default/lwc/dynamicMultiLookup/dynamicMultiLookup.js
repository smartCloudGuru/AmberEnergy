...
export default class DynamicMultiLookup extends NavigationMixin(LightningElement) {
    // Public properties
    ...
    processSelectionUpdate(isUserInteraction) {
        ...
        if (isUserInteraction) {
            const selection = this._curSelection.map((sel) => sel);
            this.dispatchEvent(new CustomEvent('selectionchange', { detail: selection }));
        }
    }
